	...
	<div class="container mt-5">
		...
		<div class="row w-100">  
			...
			<div class="col-md-3 mb-4">
				...
				<h3 class="h4 mb-4"><?php esc_html_e( 'Contacts', 'groundctrl' ); ?></h3>
			...
			<div class="col-md-3 mb-4">
				...
				<h3 class="h4 mb-4"><?php esc_html_e( 'Pages', 'groundctrl' ); ?></h3>
			...
			<div class="col-md-3 mb-4">
				...
				<h3 class="h4 mb-4"><?php esc_html_e( 'Privacy', 'groundctrl' ); ?></h3>
