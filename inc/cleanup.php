...
add_action( 'wp_enqueue_scripts', 'grnd_jquery_footer' );    // https://wordpress.stackexchange.com/a/173605/
add_action( 'init', 'grnd_disable_head_links' );


function grnd_disable_gutenberg() {
...
function grnd_disable_query_strings() {
